package com.gft.interview.infrastructure.adapter.controller;


import com.gft.interview.domain.model.Price;
import com.gft.interview.domain.port.in.GetPriorityPricePort;
import com.gft.interview.infrastructure.adapter.dto.PriceRequestDto;
import com.gft.interview.infrastructure.adapter.dto.PriceResponseDto;
import com.gft.interview.infrastructure.adapter.mapper.PriceMapper;
import com.gft.interview.infrastructure.exception.ApiError;
...
public class PriceController {
    ...
    public ResponseEntity<PriceResponseDto> getPriorityPrice(@Valid @ModelAttribute PriceRequestDto requestDto) {
        log.info("[getPriorityPrice] - Request received: {}", requestDto);
